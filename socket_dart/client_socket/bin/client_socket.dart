...
void main() async {
  ...
  // final socket = await Socket.connect('127.0.0.1', 4002);
  //change
  // final socket = await Socket.connect('192.168.216.60', 4002);
  final socket = await Socket.connect('192.168.67.60', 4002);
  // final socket = await Socket.connect('192.168.1.5', 4002);
