...
class _SocketConnectionAwaitPageState extends State<SocketConnectionAwaitPage> {
  Future<ClientSocket> _connection(String username) async {
    ...
    // await clientSocket.initialiseSocket('192.168.216.60', 4002);
    await clientSocket.initialiseSocket('192.168.67.60', 4002);
    // await clientSocket.initialiseSocket('192.168.1.5', 4002);
